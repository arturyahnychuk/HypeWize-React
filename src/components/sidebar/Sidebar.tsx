...
function Sidebar({ navbarActive, onNavClose }: SidebarProps) {
  ...
  // };
  const shouldShowHiddenLinks = !!id
  return (
    <aside
      className={`${navbarActive ? "left-0" : "left-[-300%]"
      ...
      <div className="w-full h-full flex flex-col justify-between ">
              ...
              <ul className="w-full flex flex-col gap-3">
                ...
                {shouldShowHiddenLinks && (
                  <>
                    ...
                    <NavLink
                      onClick={handleNavClose}
                      to={RoutesPath.PROJECTMESSAGES + "/" + id}
                      className={({ isActive }) =>
                        `${isActive ? "nav-active-additional" : "nav-additional"
                        } flex items-center gap-3 px-4 py-3 rounded-md group hover:bg-blue transition-all`
                      }
                    ...
                    <div className="relative border-b pb-3">
                      <NavLink
                        onClick={handleNavClose}
                        to={RoutesPath.PROJECTCONTENTS + "/" + id}
                        className={({ isActive }) =>
                          `${isActive
        ...
        <div className="flex flex-col gap-4 pl-4 pr-6">
          <div className="pb-4 border-b border-b-gray-100">
            {!shouldShowHiddenLinks && !profileInfo?.hideStarterGuide && (
              <NavLink
                onClick={handleNavClose}
          ...
          <div className="flex items-start w-full gap-3 flex-col">
            <NavLink
              ...
              className={({ isActive }) =>
                `${isActive ? "nav-active" : ""
                } flex items-center gap-3 px-4 py-3 rounded-md group hover:bg-blue transition-all w-full`
              }
            >
              <Icon
            ...
            <NavLink
              ...
              to="#"
              className="flex items-center gap-3 px-4 py-3 rounded-md group hover:bg-blue transition-all w-full"
            >
              <Icon
                className="nav-icon text-black group-hover:text-white transition-all"
                icon="logout"
