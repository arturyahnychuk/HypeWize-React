            ...
            <div className="w-full h-full sm:px-5 sm:pb-5 sm:pt-[38px]" style={{ backgroundColor: project?.themeColor }}>
              <div className="w-full h-full grid grid-rows-[180px,1fr] sm:grid-rows-[auto,1fr] sm:gap-[48px]">
                ...
                <div className="relative w-full">
                  <div className="w-full max-w-[316px] md:max-w-[648px] flex justify-center pb-[46px] sm:pb-[0px] items-end sm:block h-full mx-auto">
                  ...
                  <div className="w-full h-full py-4 px-5">
                    ...
                    >
                      <div className="w-full flex flex-col gap-5">
                        {
                          project?.formFields.map((item, index) => <Input
                            key={index}
                            name="name"
                            placeholder={`${item} *`}
                      ...
                      <div className="w-full flex flex-col gap-4 sm:gap-[14px]">
                        <button onClick={startChat}
                          type="submit"
                          className="w-full items-center justify-center rounded-[5px] py-[17px]"
                        ...
                        {project.subscription != "paid" ? <div className="flex items-center gap-1 justify-center">
                          <p className="text-sm font-secondary-regular leading-[20px] text-blackLight">
                            Powered by
                          </p>
                          <Link to="https://hypewize.com">
                            <svg
                              className="mt-1"
                              width="73"
                              height="16"
                  ...
                  <div className="w-full h-full grid grid-rows-[1fr,auto] gap-1">
                    ...
                    <div className="w-full h-full">
                      <div className="w-full flex flex-col gap-4 sm:gap-[14px]">
                        ...
                        {project.subscription != "paid" ? <div className="flex items-center gap-1 justify-center mt-[13px]">
                          <p className="text-sm font-secondary-regular leading-[20px] text-blackLight">
                            Powered by
                          </p>
                          <Link to="https://hypewize.com">
