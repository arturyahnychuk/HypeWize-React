...
function MessagesSingle() {
  ...
  return (
    <PageLayout>
      ...
      <div className="w-full grid md:grid-cols-2 md:gap-5 items-baseline">
        <div className="sticky top-[97px] w-full h-max rounded-[10px] md:rounded-[0px]">
          ...
          >
            <div className="w-full h-full h-[calc(100vh-300px)]  md:h-[calc(100vh-120px)] bg-white rounded-b-[10px] md:rounded-[10px] pr-1">
              <div className="w-full px-5 pt-4 hidden md:flex">
                <p className="border-b w-full pb-4 text-md text-black">
                  Messages
                </p>
              </div>
              <div className="h-[calc(100vh-268px)] px-2 md:h-[calc(100vh-180px)] overflow-auto custom-scrollbar">
                <div className="flex flex-col md:mt-4  md:rounded-[10px] py-4">
                    ...
                    <div className="flex items-start gap-4 h-full">
                      ...
                      <div className="flex flex-col gap-2 max-w-[75%]">
                        <div className="p-4 pr-6 bg-gray-500 rounded-[12px] w-full">
                          <p className="text-xs md:text-sm text-black2 leading-[20px] ">
                    ...
                    <div className="flex items-start justify-end gap-4 h-full">
                      <div className="flex flex-col gap-2 max-w-[75%]">
                        <div className="p-4 pr-6 bg-blue rounded-[12px] w-full">
                          <p className="text-white text-xs md:text-sm leading-[20px]">
        ...
        <div className="w-full grid grid-cols-1 gap-[10px] pb-7">
          ...
          >
            <div className="w-full flex justify-between items-center">
              <div className="w-full flex items-center px-5 md:pt-2">
                <div className="w-full md:border-b flex pb-1 md:pb-2 pt-2 md:pt-1 items-center justify-between">
                  ...
                  {!addTag ? (
                    <>
                      <div className="md:flex hidden">
                        <Btn
                          ...
                          width={16}
                          height={16}
                          className="action-btn success stroke hover-green !px-0 md:!pl-5"
                        />
                      </div>
                    ...
                    <>
                    <p className="font-secondary-regular md:hidden flex text-black2 text-base">Name</p>
            ...
            <div className="md:pt-3 pb-5 md:py-5 pr-2">
              <div className={`${addTag ? 'h-[calc(100vh-349px)]' : 'h-[calc(100vh-349px)]'} md:max-h-[125px] px-5 overflow-auto custom-scrollbar pr-[7px]`}>
                {!addTag ? (
                  ...
                  <div className="flex flex-col items-start gap-2 mt-1 md:mt-2">
                    <label htmlFor="welcome_message" className="text-sm md:flex hidden">
                      Embed Code
                    </label>
                    <Input
                      type="text"
          ...
          >
            <div className="w-full flex justify-between items-center">
              <div className="w-full flex items-center px-5 pt-3">
                <div className="w-full border-b hidden md:flex pb-4 md:pt-1 items-center justify-between">
                  <p className="text-md text-black">Data Collected</p>
                </div>
              </div>
            </div>
            <div className="pt-2 pb-5 md:pb-5 md:pt-4 px-5 pr-[5px]">
              <div className="flex flex-col h-[calc(100vh-310px)] md:max-h-[140px] overflow-auto custom-scrollbar pr-[7px]">
          ...
          >
            <div className="w-full flex justify-between items-center">
              <div className="w-full flex items-center px-5 pt-2">
                <div className="w-full  md:border-b flex md:pb-2 md:pt-1 items-center justify-between">
                  ...
                  {!editNote ? (
                    ...
                    <>
                      <div className="flex gap-4  pb-0 md:pb-2 py-2 items-center ml-auto">
                        <Btn
            ...
            <div className="py-5 px-5">
              <div className={`${!editNote ? 'h-[calc(100vh-362px)]' : 'h-[calc(100vh-355px)]'} md:max-h-[120px] overflow-auto custom-scrollbar pr-[7px]`}>
                {!editNote ? (
                  ...
                  <div className="flex flex-col items-start gap-2">
                    <Textarea
                      ...
                      value={noteVal}
                      placeholder=""
                      className="overflow-hidden resize-none  h-[calc(100vh-360px)] md:h-auto md:min-h-[140px] border-dashed !p-2"
                    />
                  </div>
                )}
              </div>
